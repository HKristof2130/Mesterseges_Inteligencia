...
export class DestinatonsGeneratorService {
  ...
  public destinations: Map<number, City> = new Map<number, City>();

  constructor() { }

  generateDestinations(amountOfDestinationsInEachQuadrant: number): void {

    DestinatonsGeneratorService.destinationCounter = 0;
    this.destinations.clear();

    this.destinations.set(DestinatonsGeneratorService.destinationCounter, {
